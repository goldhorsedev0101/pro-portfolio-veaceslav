...
export const ReactIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <circle cx="12" cy="12" r="2" />
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c1.54 0 3-.4 4.29-1.1l-1.5-2.6c-.5.2-1.05.3-1.6.3-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6c0 .55-.1 1.1-.3 1.6l2.6 1.5c.7-1.29 1.1-2.75 1.1-4.3C20 6.48 15.52 2 12 2z" />
  </svg>
);
...
export const NextJSIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="12" y="16" fontSize="10" fontWeight="bold" textAnchor="middle" fill="white">N</text>
  </svg>
);
...
export const NestJSIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export const AngularIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.96 12.5l-1.5-3.5h-2.5l4.5 10 4.5-10h-2.5l-1.5 3.5h-1.5zm-1.5-3.5L12 3l3.54 6h-2.5L12 6.5l-1.04 2.5h-2.5z" />
  </svg>
);

export const GraphQLIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18l8 4v8.64l-8 4-8-4V8.18l8-4z" />
    ...
    <line x1="12" y1="10.5" x2="6" y2="8" />
    <line x1="12" y1="10.5" x2="18" y2="8" />
    <line x1="12" y1="13.5" x2="6" y2="16" />
    <line x1="12" y1="13.5" x2="18" y2="16" />
  </svg>
);
...
export const PythonIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M9.585 2.568c-1.35 0-2.475.9-2.475 2.1v1.05h-1.05c-1.2 0-2.1.9-2.1 2.1v8.4c0 1.2.9 2.1 2.1 2.1h1.05v1.05c0 1.2 1.125 2.1 2.475 2.1h4.83c1.35 0 2.475-.9 2.475-2.1v-1.05h1.05c1.2 0 2.1-.9 2.1-2.1v-8.4c0-1.2-.9-2.1-2.1-2.1h-1.05V4.668c0-1.2-1.125-2.1-2.475-2.1h-4.83zm-.525 1.05h4.83c.75 0 1.425.6 1.425 1.35v1.05H7.635V4.968c0-.75.675-1.35 1.425-1.35zm-3.675 3.15h12.6c.6 0 1.05.45 1.05 1.05v8.4c0 .6-.45 1.05-1.05 1.05H5.385c-.6 0-1.05-.45-1.05-1.05v-8.4c0-.6.45-1.05 1.05-1.05zm7.875 1.05c-.6 0-1.05.45-1.05 1.05s.45 1.05 1.05 1.05 1.05-.45 1.05-1.05-.45-1.05-1.05-1.05zm-4.2 0c-.6 0-1.05.45-1.05 1.05s.45 1.05 1.05 1.05 1.05-.45 1.05-1.05-.45-1.05-1.05-1.05zm8.4 6.3H7.635v1.05c0 .75.675 1.35 1.425 1.35h4.83c.75 0 1.425-.6 1.425-1.35v-1.05z" />
  </svg>
);
...
export const AWSIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M5.8 18.5h1.3l.3-.6 1.4-2.8h5.8l1.4 2.8.3.6h1.3L12.4 5h-1.1L5.8 18.5zm3.5-6.2l2.1-4.2 2.1 4.2H9.3z" />
  </svg>
);
...
export const VueIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18l8 4v8.64l-8 4-8-4V8.18l8-4z" />
    <path d="M12 6L6 18h2l1.5-3h5L17 18h2L12 6zm0 3.5L14.5 15h-5L12 9.5z" />
  </svg>
);
...
export const JavaScriptIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <rect x="2" y="2" width="20" height="20" rx="2" />
    <text x="12" y="16" fontSize="10" fontWeight="bold" textAnchor="middle" fill="white">JS</text>
  </svg>
);
...
export const KotlinIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18l8 4v8.64l-8 4-8-4V8.18l8-4z" />
    <text x="12" y="16" fontSize="12" fontWeight="bold" textAnchor="middle" fill="white">K</text>
  </svg>
);
...
export const FlutterIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18l8 4v8.64l-8 4-8-4V8.18l8-4z" />
    <text x="12" y="16" fontSize="12" fontWeight="bold" textAnchor="middle" fill="white">F</text>
  </svg>
);

export const ExpressJSIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.94-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z" />
    <text x="12" y="16" fontSize="8" fontWeight="bold" textAnchor="middle" fill="white">ex</text>
  </svg>
);
...
export const DjangoIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="12" y="16" fontSize="9" fontWeight="bold" textAnchor="middle" fill="white">dj</text>
  </svg>
);
...
export const FirebaseIcon: React.FC<{ className?: string }> = ({ className }) => (
  <svg className={className || "w-8 h-8"} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M12 2L2 7v10l10 5 10-5V7L12 2zm0 2.18l8 4v8.64l-8 4-8-4V8.18l8-4z" />
    <path d="M12 8l-4 8h8l-4-8zm0 2.5l2 4h-4l2-4z" />
  </svg>
);
